...
module visibility_bucket {
  source = "../../state/object_store/visibility_data_bucket"
...
module log_delivery_bucket {
  source = "../../state/object_store/logging_bucket"
  unique_suffix = var.unique_suffix
  account_id = var.account_id
  region = var.region
...
module cost_report_delivery_bucket {
  source = "../../state/object_store/bucket"
  account_id = var.account_id
  unique_suffix = var.unique_suffix
  region = var.region
...
module site_metric_function {
  source = "../../utility_functions/cloudfront_request_summarizer"
  unique_suffix = var.unique_suffix
  account_id = var.account_id
  region = var.region
...
module cost_report_function {
  source = "../../utility_functions/cur_report_parser"
  unique_suffix = var.unique_suffix
  account_id = var.account_id
  region = var.region
  logging_config = local.lambda_logging_config
